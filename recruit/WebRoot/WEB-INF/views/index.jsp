			...
			<div class="camera_wrap m_bottom_0">
				<div data-src="<%=path%>/images/slide_013.jpg" data-custom-thumb="<%=path%>/images/slide_013.jpg">
					<!-- <div class="camera_caption_1 fadeFromTop t_align_c d_xs_none">
						...
						<div class="color_light slider_title_2 m_bottom_45"><b>2018-05-22</b></div>
    			...
    			<div data-src="<%=path%>/images/slide_012.jpg" data-custom-thumb="<%=path%>/images/slide_012.jpg">
    				<div class="camera_caption_2 fadeIn t_align_c d_xs_none">
						...
						<div class="color_light slider_title tt_uppercase t_align_c m_bottom_65 m_sm_bottom_20"><b><span class="scheme_color"> 2018-05-22</span><br><span class="color_dark">Ready-To-Wear</span></b></div>
							...
							<div class="blog_carousel">
								<div class="clearfix">
									...
									<div class="mini_post_content">
										...
										<p class="f_size_medium m_bottom_10 animate_ftr">2018-3-25</p>
								...
								<div class="clearfix">
									...
									<div class="mini_post_content">
										...
										<p class="f_size_medium m_bottom_10 animate_ftr">2018-2-27</p>
								...
								<div class="clearfix">
									...
									<div class="mini_post_content">
										...
										<p class="f_size_medium m_bottom_10 animate_ftr">2018-4-12</p>
